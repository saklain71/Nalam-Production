    ...
    return (
        <div
            ...
            <footer className="footer p-10 bg-base-200 text-base-content">
                <div>
                    <span className="footer-title text-xl font-bold text-info">Services</span>
                ...
                <div>
                    <span className="footer-title text-xl font-bold text-info">Company</span>
                ...
                <div>
                    <span className="footer-title text-xl font-bold text-info">Legal</span>
                    <Link to="/" className="link link-hover">Terms of use</Link>
                    <Link to="/" className="link link-hover">Privacy policy</Link>
                    <Link to="/" className="link link-hover">Cookie policy</Link>
                </div>
            </footer>
            <footer className="footer px-10 py-4 border-t bg-info text-white border-base-300">
                <div className="items-center grid-flow-col">
                    <div>
                        <p>Copyright © 2022 - All right reserved by 
                            <span className='text-red-500'> Nalam Production Ltd</span>
                        </p>
                    </div>
                </div>
